		...
		//https://docs.spring.io/spring-security/reference/5.8/servlet/exploits/csrf.html
			...
			.authorizeHttpRequests(authorize->
				authorize
					...
					.antMatchers("/","/signin","/signup").permitAll()//Specify that URLs are allowed by anyone.
					.antMatchers("/boards-main").permitAll()
			...
			.formLogin(form->//{}
				form
					...
					.loginProcessingUrl("/signin-proc") //form action과 일치하게 설정
